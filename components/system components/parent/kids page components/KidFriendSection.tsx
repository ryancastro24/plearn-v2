...
import KidsFriendsSideNavigation from "@/components/system components/parent/kids page components/KidsFriendsSideNavigation";
import KidFriendDesktopChatBox from "@/components/system components/parent/kids page components/KidFriendDesktopChatBox";
