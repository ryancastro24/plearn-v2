...
const StudentDesktopSideNavigation = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      icon: IoStorefront,
      label: "Store",
      active: pathname.includes("/dashboard/student/store"),
    },
    {
      href: "/dashboard/student/friends",
      icon: FaChildren,
      label: "Friends",
      active: pathname.includes("/dashboard/student/friends"),
    },
  ];
...
export default StudentDesktopSideNavigation;
